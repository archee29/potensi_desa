    ...
    <div class="container-fluid pt-4 px-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><i class="fa fa-place-of-worship me-2"></i>Album Desa</li>
                <li class="breadcrumb-item"><a href=""><i class="fas fa-plus-circle me-2"></i>Tambah
                        Data Album Desa</a></li>
            </ol>
        </nav>
        <div class="row vh-80 bg-light rounded mx-0">
            <div id="create" class="col-sm-12 col-xl-12">
                <div class="bg-light rounded h-100 p-4">
                    <div class="card">
                        <div class="card-header">Tambah Data Album Desa</div>
                        <div class="card-body">
                            <form action="{{ route('albumdesa.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
