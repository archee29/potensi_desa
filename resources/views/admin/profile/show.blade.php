    ...
    <div class="container-fluid pt-4 px-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><i class="fa fa-newspaper me-2"></i>Profile</li>
                <li class="breadcrumb-item"><a href="/lokasi"><i class="fas fa-eye me-2"></i>Detail Data Profile</a></li>
            </ol>
        </nav>
