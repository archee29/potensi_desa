                            ...
                            <form action="{{ route('wisata-desa.update', $wisata_desa) }}" method="POST"
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="location"
                                        ...
                                        <input name="location" value="{{ $wisata_desa->location }}" type="text" class="form-control @error('location') is-invalid @enderror" placeholder="Klik Button Untuk Mendapatkan Titik" posisi = "sekarang" aria-label="posisi" aria-describedby="button-addon1" readonly>                                     
                                    </div>                             
                                    @error('location')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
