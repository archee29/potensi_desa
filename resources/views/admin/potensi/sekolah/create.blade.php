    ...
    <div class="container-fluid pt-4 px-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="/sekolah/create"><i class="fas fa-plus-circle me-2"></i>Tambah Data
                        Sekolah</a>
                </li>
            </ol>
        </nav>
                            ...
                            <form action="{{ route('sekolah.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <button class="btn btn-outline-primary btn-block mt-3 mb-3" type="button"
                                        id="button-addon1" onclick="getlokasi()">Dapatkan Titik</button>
                                    @error('location')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
    ...
    <script>
        ...
        function showPosition(posisi) {
            ...
            L.marker([posisi.coords.latitude, posisi.coords.longitude])
                .addTo(map)
                .bindPopup("<b>Hai!</b><br />Ini adalah Lokasi Sekolah");
