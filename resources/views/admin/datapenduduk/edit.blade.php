    ...
    <div class="container-fluid pt-4 px-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><i class="fa fa-place-of-worship me-2"></i>Penduduk Desa</li>
        ...
        <div class="row vh-80 bg-light rounded mx-0">
            <div id="edit" class="col-sm-12 col-xl-12">
                <div class="bg-light rounded h-100 p-4">
                    <div class="card">
                        <div class="card-header">Edit Data Penduduk Desa</div>
                        <div class="card-body">
                            <form action="{{ route('datapenduduk.update', $datapenduduk) }}" method="POST"
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" name="dusun"
                                        ...
                                        placeholder="Nama Desa" value="{{ $datapenduduk->dusun }}">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" name="cowok"
                                        ...
                                        placeholder="Nama Desa" value="{{ $datapenduduk->cowok }}">
                                    <label for="floatingInput">Laki - Laki</label>
                                    @error('cowok')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" name="cewek"
                                        class="form-control @error('cewek') is-invalid @enderror" id="floatingInput"
                                        placeholder="Nama Desa" value="{{ $datapenduduk->cewek }}">
                                    <label for="floatingInput">Perempuan</label>
                                    @error('cewek')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" name="jumlah"
                                        ...
                                        placeholder="Nama Desa" value="{{ $datapenduduk->jumlah }}">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" name="luas"
                                        ...
                                        placeholder="Nama Desa" value="{{ $datapenduduk->luas }}">
                                    <label for="floatingInput">Luas Wilayah (KM2)</label>
                                    @error('luas')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
